...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-1 text-gray-500">Update your product listing</p>
    </div>
    ...
    <form action="{{ route('farmer.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors">{{ old('description', $product->description) }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="unit" id="unit" required
                        ...
                        <option value="dozen" {{ old('unit', $product->unit) == 'dozen' ? 'selected' : '' }}>Dozen (12)</option>
        ...
        {{-- Current Images --}}
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6" x-data="{ removedImages: [] }">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                ...
                <div class="relative group" x-show="!removedImages.includes('{{ $image }}')">
                    <img src="{{ asset('storage/' . $image) }}" alt="Product image" class="w-full h-32 object-cover rounded-lg border border-gray-200">
                    <button type="button"
            ...
            @else
            <p class="text-sm text-gray-400 mb-4">No images uploaded yet.</p>
            @endif

            {{-- Upload New Images --}}
            <h3 class="text-sm font-medium text-gray-700 mb-2">Add More Images</h3>
            <div x-data="{ newPreviews: [] }">
                <label class="block cursor-pointer">
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-emerald-400 transition-colors">
                        ...
                        <p class="text-xs text-gray-400">PNG, JPG, WEBP up to 2MB each</p>
                    </div>
